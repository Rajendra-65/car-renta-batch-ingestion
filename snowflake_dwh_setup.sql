...
STORAGE_ALLOWED_LOCATIONS = ('gcs://snowflake_projects_all/car_rental_data/customer_daily_data/')
ENABLED = TRUE;

DESC INTEGRATION gcs_car_rental_integration;

CREATE OR REPLACE STAGE car_rental_data_stage
URL = 'gcs://snowflake_projects_all/car_rental_data/customer_daily_data/'
