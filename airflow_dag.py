...
CLUSTER_NAME = 'cluster-for-spark-practice'
PROJECT_ID = 'smiling-castle-431016-v3'
REGION = 'us-east1'

pyspark_job_file_path = 'gs://snowflake_projects_all/spark_job/spark_job.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    dag=dag,
    dataproc_jars=['gs://snowflake_projects_all/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar', 'gs://snowflake_projects_all/snowflake_jars/snowflake-jdbc-3.16.0.jar']
)
